...
public class Alphabetic_List_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alphabetic_list);
...
releaseMedia();
mediaPlayer = MediaPlayer.create(Alphabetic_List_Activity.this,arrayList.get(position).getRaw_ID());
mediaPlayer.start();
mediaPlayer.setOnCompletionListener(completionListener);
        }
    });
